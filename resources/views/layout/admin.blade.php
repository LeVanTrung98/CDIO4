    ...
    <aside id="left-panel" class="left-panel">
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand hidden" href="./"><img src="/upImage/1570367231.jpg" alt="Logo"></a>
            </div>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <h3 class="menu-title">Management</h3><!-- /.menu-title -->
                     ...
                     <li class="menu-item-has-children ">
                        <a href="{{route('home.index')}}" class="dropdown-toggle" ><i class="fas fa-list mr-5"></i>Post</a>
                    </li>
                     <li class="menu-item-has-children ">
                        <a href="{{route('infringe.index')}}" class="dropdown-toggle" ><i class="fas fa-list mr-5"></i>Infringes</a>
                    </li>
                ...
                <div class="col-sm-5">
                    <div class="user-area dropdown float-right">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img class="user-avatar rounded-circle" src="/upImage/1570367231.jpg" alt="User Avatar">
                        </a>
